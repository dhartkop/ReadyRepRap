...
#define CUSTOM_MACHINE_NAME "ReadyRepRap"
...
#define DELTA
  ...
  #define DELTA_EFFECTOR_OFFSET 35.5 // mm - new measure as of 2015-12-30
  
  // Horizontal offset of the universal joints on the carriages.
  //#define DELTA_CARRIAGE_OFFSET 58.0 // mm
  #define DELTA_CARRIAGE_OFFSET 15.75 // mm - new measure as of 2015-12-30
...
//#if ENABLED(AUTO_BED_LEVELING_FEATURE)
  ...
  #define AUTO_BED_LEVELING_GRID  // Deltas only support grid mode.
    ...
    #define DELTA_PROBABLE_RADIUS (DELTA_PRINTABLE_RADIUS - 100)
...
//#define Z_PROBE_END_SCRIPT "G1 Z10 F12000\nG1 X15 Y330\nG1 Z0.5\nG1 Z10" // These commands will be executed in the end of G29 routine.
  ...
  // Deploys by touching z-axis belt. Retracts ramps
  // by pushing the probe down. Uses Z_MIN_PIN.
